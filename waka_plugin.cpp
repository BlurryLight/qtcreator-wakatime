...
void WakaPlugin::trySendHeartbeat(const QString &entry, bool isSaving = false)
{
    ...
    QTC_ASSERT(_wakaOptions->isEnabled(), Core::MessageManager::write("Wakatime reporting explicitly disabled!"); return; );
...
void WakaPlugin::onInStatusBarChanged()
{
    ...
    {
        if(_heartBeatButton.data() != nullptr)
        {
...
void WakaPlugin::onEditorAboutToChange([[maybe_unused]]Core::IEditor *editor)
{
